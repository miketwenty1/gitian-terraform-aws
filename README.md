...
The method used for this gitian build process is docker. Bitcoin tar.gz/zipped up binaries for windows and linux will be made in `/gitian/bitcoin/bitcoin-binaries/${VERSION}/`
...
### NOTES:
- The purpose of this module is to easily check the gitian build checksums for themselves extra manual steps are required if you want to be a gitian signer:
